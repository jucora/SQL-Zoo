...
SELECT name, continent, population FROM world AS w1 WHERE 25000000 > ALL(SELECT population FROM world AS w2 WHERE w1.continent = w2.continent AND population > 0);
